...
from core.views import index, product_list_view, category_list_view, \
    ...
    profile_view, address_view,  order_history_view, track_order_view, contact_view, change_password_view, place_order_completed, \
   revenue_management, staff_management, inventory_management, api_orders, order_management, update_order_status, order_stats_api
...
urlpatterns=[
    ...
    path('api/orders/<str:order_id>/status/', update_order_status, name='update_order_status'),
    path('api/order-stats/', order_stats_api, name='order_stats_api'),
]